...
*                                                                              
* FILE:                                                                        
*   FIR2_100.c         2000/03/22                                              
*                                                                              
*  Copyright (c) 2000 dSPACE GmbH, GERMANY                                     
*                                                                              
*  $Workfile: FIR2_100.c $ $Revision: 7 $ $Date: 14.01.04 16:27 $ $Author: Markuss $                           
******************************************************************************/
...
*
* Function:
*   F__U16FIR16_U8CBU8(Input,NTabs,DelayLine,Coeff,Counter)
*
* DESCRIPTION:
...
UInt8    *AuxDelayLine;
	...
	*AuxDelayLine = Input; 
	...
	for(i=0;i<NTabs;i++)
	{
	   Accu += (UInt16)*AuxDelayLine++ * (UInt16)*Coeff++;	    		
