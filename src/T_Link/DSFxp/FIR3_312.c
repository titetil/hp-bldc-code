...
*                                                                              
* FILE:                                                                        
*   FIR3_312.c         2000/03/22                                              
*                                                                              
*  Copyright (c) 2000 dSPACE GmbH, GERMANY                                     
*                                                                              
*  $Workfile: FIR3_312.c $ $Revision: 5 $ $Date: 14.01.04 16:27 $ $Author: Markuss $                           
******************************************************************************/
...
*
* Function:
*   F__U64FIR64_SAT_U16CBU32(Input,NTabs,DelayLine,Coeff,Counter,Result_h,Result_l)
*
* DESCRIPTION:
...
UInt16    i;
	...
	*AuxDelayLine = Input; 
	...
	for(i=0;i<NTabs;i++)
	{
       ...
       AuxDelayLine++;Coeff++;
       C__U64ADDU64U64_SAT(Mul_h,Mul_l,Accu_h, Accu_l, Accu_h, Accu_l);	   
