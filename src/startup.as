	...
	; Compiler options:
	;
	; -oBVH2_V0.9.3.cof -mBVH2_V0.9.3.map --summary=default \
	; --output=default adc.p1 bldc.p1 cksum.p1 diag.p1 eeprom.p1 \
	; interrupt.p1 lin.p1 main.p1 pwm.p1 BVH2_Appl_Layer.p1 timer.p1 \
	; --chip=16F1936 -ID:\Projekte\BVH2\BLDC\V0.9.3\src\T_Link -P \
