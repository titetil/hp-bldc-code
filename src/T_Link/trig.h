...
*
*  $Workfile: trig.h $ $Revision: 9 $ $Date: 13.11.03 13:41 $ $Author: Dagmara $
******************************************************************************/
...
*
* NOTE:     
*   With 16 bit input type and 16 bit output type th calculation of sine uses 
*   a table. In 32 bit serires approach with various number of summands.
*
******************************************************************************/
Int16 F__I16SINI16(Int16 v);

#define F__I16SINI32(v)\
    F__I16SINI16((Int16) v)

#define F__I16SINI64(v_h, v_l)\
    F__I16SINI16((Int16) v_l)
...
#define F__I16COSI32(v)\
    F__I16COSI16((Int16) v)

#define F__I16COSI64(v_h, v_l)\
    F__I16COSI16((Int16) v_l)
...
*
*   Int16 F__I16TANI16
*   Int16 F__I16TANI16_ARB
*   Int32 F__I32TANI32_LE7
*   Int32 F__I32TANI32_LE7_ARB
*   Int32 F__I32TANI32_LE8
*   Int32 F__I32TANI32_LE8_ARB
*   Int32 F__I32TANI32_LE9
*   Int32 F__I32TANI32_LE9_ARB
*   Int32 F__I32TANI32_LE10
*   Int32 F__I32TANI32_LE10_ARB
*   Int32 F__I32TANI32_LE11
*   Int32 F__I32TANI32_LE11_ARB
*   F__I16TANI32   
*   F__I16TANI32_ARB
*   F__I16TANI64(
*   F__I16TANI64_ARB
*   F__I32TANI64_LE7
*   F__I32TANI64_LE7_ARB
*   F__I32TANI64_LE8
*   F__I32TANI64_LE8_ARB
*   F__I32TANI64_LE9
*   F__I32TANI64_LE9_ARB
*   F__I32TANI64_LE10
*   F__I32TANI64_LE10_ARB
*   F__I32TANI64_LE11
*   F__I32TANI64_LE11_ARB
*
* NOTE:     
...
#define F__I16TANI32(v, ysh)\
    F__I16TANI16((Int16)v, ysh)

#define F__I16TANI32_ARB(v, yN, yD)\
    F__I16TANI16_ARB((Int16)v, yN, yD)

#define F__I16TANI64(v_h, v_l, ysh)\
    F__I16TANI16((Int16)v_l, ysh)

#define F__I16TANI64_ARB(v_h, v_l, yN, yD)\
    F__I16TANI16_ARB((Int16)v_l, yN, yD)
...
/******************************************************************************
*
*   Int16 F__I16ACOSI16(v)
*
* NOTE:     
*   acos is implemented using asin.
*
******************************************************************************/
#define F__I16ACOSI16(v)\
    (UInt16)(25736 - (UInt16)F__I16ASINI16(v))
