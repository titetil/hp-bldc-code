...
*
* FILE:
*   TAN_10a.c         2002/11/19
*
*  Copyright (c) 2000 dSPACE GmbH, GERMANY
*
*  $Workfile: TAN_10a.c $ $Revision: 2 $ $Date: 28.10.03 14:34 $ $Author: Dagmara $
******************************************************************************/
...
Int32 F__I32TANI32_LE10_ARB(Int32 v, Int32 yN, Int32 yD)
{
    ...
    else
    {
        ...
        v = v >> 1;
        y_sin = F__I32SINI32_LE10(v);
        y_cos = F__I32SINI32_LE10(v + 0x40000000);
