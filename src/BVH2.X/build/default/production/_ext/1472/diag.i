...
# 94 "../diag.c"
unsigned char ui8_lin_sim_Failures;
unsigned char ui8_lin_sim_Failures_ena;
unsigned char Error_PICetatMonitor;
unsigned char DC_pic_etat_monitor;
unsigned char ui8_cnt1;
unsigned char ui8_cnt_PWM;
unsigned char ict_stamp = 1;
unsigned char wkpoint = 1;
unsigned char phaseCal = 0;
unsigned char ui8_failure = 7;
...
extern unsigned int checksum[ 3 ];
...
if( 0x80 == ui8_selected_lid )

{

ui8_selected_lid = 0x90;
ict_stamp = 1;
...
ui8_b_DResB0_RD = read_eeprom_data( 0xf0 );
ui8_b_DResB1_RD = read_eeprom_data( 0xf1 );
ui8_b_DResB2_RD = read_eeprom_data( 0xf2 );
ui8_b_DResB3_RD = read_eeprom_data( 0xf3 );
ui8_b_DResB4_RD = 0;
ui8_b_DResB5_RD = 0;
...
ui8_b_DResB0_RD = read_eeprom_data( 0xeb );
ui8_b_DResB1_RD = read_eeprom_data( 0xec );
ui8_b_DResB2_RD = read_eeprom_data( 0xed );
ui8_b_DResB3_RD = read_eeprom_data( 0xee );
ui8_b_DResB4_RD = read_eeprom_data( 0xef );
ui8_b_DResB5_RD = 0;

ui8_selected_lid = 0x91;
break;
...
Transmit_LIN_8Bytes( 0x10, 0x7F, 0x90, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF );
...
if( 0x91 == ui8_selected_lid )

{

# 672
ui8_b_DResB0_RD = read_eeprom_data( 0xf4 );
ui8_b_DResB1_RD = read_eeprom_data( 0xf5 );
ui8_b_DResB2_RD = read_eeprom_data( 0xf6 );
ui8_b_DResB3_RD = read_eeprom_data( 0xf7 );
ui8_b_DResB4_RD = read_eeprom_data( 0xf8 );
ui8_b_DResB5_RD = 0;
...
if( 0x93 == ui8_selected_lid )

{

# 850
sum = cksum( );
checksum[ 1 ] = ( __flash_read(0x1FFF) );
checksum[ 2 ] = ( __flash_read(0x1FFE) );
checksum[ 0 ] = ( checksum[ 1 ]<<8 ) + checksum[ 2 ];


ui8_b_DResB0_RD = 0x02;
ui8_b_DResB1_RD = 0x00;
...
ui8_b_DResB0_RD = ( unsigned char )( ui16_fir_Bat_mittel>>2 );
ui8_b_DResB1_RD = 0;
ui8_b_DResB2_RD = 0;
ui8_b_DResB3_RD = 0;
ui8_b_DResB4_RD = 0;
...
{ unsigned char _dcnt; if( 200 >= 4 ) _dcnt = ( 200 * ( 32000000UL ) / 2 ); else _dcnt = 1; while( --_dcnt > 0 ) { asm( "nop" ); asm( "nop" ); continue; } };
{ unsigned char _dcnt; if( 200 >= 4 ) _dcnt = ( 200 * ( 32000000UL ) / 2 ); else _dcnt = 1; while( --_dcnt > 0 ) { asm( "nop" ); asm( "nop" ); continue; } };
{ unsigned char _dcnt; if( 200 >= 4 ) _dcnt = ( 200 * ( 32000000UL ) / 2 ); else _dcnt = 1; while( --_dcnt > 0 ) { asm( "nop" ); asm( "nop" ); continue; } };
{ unsigned char _dcnt; if( 200 >= 4 ) _dcnt = ( 200 * ( 32000000UL ) / 2 ); else _dcnt = 1; while( --_dcnt > 0 ) { asm( "nop" ); asm( "nop" ); continue; } };
{ unsigned char _dcnt; if( 200 >= 4 ) _dcnt = ( 200 * ( 32000000UL ) / 2 ); else _dcnt = 1; while( --_dcnt > 0 ) { asm( "nop" ); asm( "nop" ); continue; } };
...
ui8_b_DResB1_RD = ( unsigned char )( ( ( ui16_IPhase1_bldc_cal.w * ui16_I_cal_Ph1 )>>8 )>>8 );
ui8_b_DResB2_RD = ( unsigned char )( ( ui16_IPhase1_bldc_cal.w * ui16_I_cal_Ph1 )>>8 );
ui8_b_DResB3_RD = ( unsigned char )( ui16_I_cal_Ph1 >> 8);
...
ui8_b_DResB1_RD = PWMReadDC( )>>1;
ui8_b_DResB2_RD = ui16_speed_fil*5/4;
ui8_b_DResB3_RD = PWM_trans_table[ ui8_b_DResB1_RD ];
ui8_b_DResB4_RD = 0;
ui8_b_DResB5_RD = 0;
...
PWM_Write_Out( 55 );
ui8_error_Flags.bits.B0 = 0;
ui8_error_Flags.bits.B1 = 0;
ui8_error_Flags.bits.B7 = 0;
ui8_error_Flags.bits.B2 = 0;
ui8_error_Flags.bits.B3 = 1;
ui8_error_Flags.bits.B4 = 0;
ui8_error_Flags.bits.B6 = 0;
ui8_error_Flags.bits.B5 = 0;
ui8_b_DResB1_RD = 55;
ui8_b_DResB0_RD = 8;
ui8_failure = 3;
break;
...
ui8_error_Flags.bits.B7 = 0;
ui8_error_Flags.bits.B2 = 0;
ui8_error_Flags.bits.B3 = 0;
ui8_error_Flags.bits.B4 = 0;
ui8_error_Flags.bits.B6 = 0;
ui8_error_Flags.bits.B5 = 1;
...
if( 0xa0 == ui8_selected_lid )

{

# 2285
write_eeprom_data( 0xf4, ui8_b_DResB0_c );
write_eeprom_data( 0xf5, ui8_b_DResB1_c );
write_eeprom_data( 0xf6, ui8_b_DResB2_c );
write_eeprom_data( 0xf7, ui8_b_DResB3_c );
write_eeprom_data( 0xf8, ui8_b_DResB4_c );
