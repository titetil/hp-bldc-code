...
*
*  $Workfile: adv64.h $ $Revision: 8 $ $Date: 28.10.03 15:21 $ $Author: Dagmara $
******************************************************************************/
...
/* Definition of basic type */
 ...
 typedef union 
 {
 ...
 #ifdef BIG_ENDIAN	/* Target with little-endian architecture */
  ...
  {
	UInt32 lng;
	UInt16 pr[2]; /* element 0: hi; element 1: lo */
  } UInt32s;
 #else
