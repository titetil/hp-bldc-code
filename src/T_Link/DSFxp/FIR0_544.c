...
*                                                                              
* FILE:                                                                        
*   FIR0_544.c         2000/03/22                                              
*                                                                              
*  Copyright (c) 2000 dSPACE GmbH, GERMANY                                     
*                                                                              
*  $Workfile: FIR0_544.c $ $Revision: 6 $ $Date: 14.01.04 16:27 $ $Author: Markuss $                           
******************************************************************************/
...
*
* Function:
*   F__I16FIR16_I8I8(Input,NTabs,DelayLine,Coeff)
*
* DESCRIPTION:
...
Int16    Accu = 0;
	...
	*DelayLine = Input;
	...
	for(i=0;i<NTabs;i++)
	{
	   Accu += (Int16)*DelayLine++ * (Int16)*Coeff++;	    		
	}
	return  Accu;
}
