...
# 54 "../adc.c"
volatile _u_wb analog_value;
unsigned int inputArray1[ 8 ];
unsigned int ui16_fir_Bat_mittel = 0;
_u_wb ui16_fir_IPhase_mean = 0;
unsigned int ui16_fir_UPhase_mittel = 0;
unsigned int ui16_NTC_Temp_bldc_mean = 0;
unsigned int ui16_CPU_Temp_bldc_mean = 0;
unsigned char windowPtr1;
unsigned int filter1 = 0;
unsigned int filter3 = 0;
unsigned int filterPh = 0;
unsigned int filterTempNTC = 0;
unsigned int filterTempCPU = 0;
unsigned int ui16_CPU_Temp_bldc_mean_cal;
unsigned int ui16_NTC_Temp_bldc_mean_cal;
unsigned char ui8_temp_calibration;
...
analog_value.b.hi = ADRESH;
analog_value.b.lo = ADRESL;
...
for( windowPtr1 = 0; windowPtr1 < 8; windowPtr1++ )
