...
*                                                                              
* FILE:                                                                        
*   FIR2_200.c         2000/03/22                                              
*                                                                              
*  Copyright (c) 2000 dSPACE GmbH, GERMANY                                     
*                                                                              
*  $Workfile: FIR2_200.c $ $Revision: 7 $ $Date: 14.01.04 16:27 $ $Author: Markuss $                           
******************************************************************************/
...
*
* Function:
*   F__U32FIR32_U8CBU8(Input,NTabs,DelayLine,Coeff,Counter)
*
* DESCRIPTION:
...
UInt8    *AuxDelayLine;
	...
	*AuxDelayLine = Input; 
	...
	for(i=0;i<NTabs;i++)
	{
	   Accu += (UInt32)((UInt16)*AuxDelayLine++ * (UInt16)*Coeff++);	    		
