...
*
* FUNCTION:
*   F__I32COSI32_6TERMS(v)
*
* DESCRIPTION:
*   Calculates 6 terms of cosine series. 
...
Int32 F__I32COSI32_6TERMS(Int32 v)
{
    ...
    F__I64MULU32U32(x2, 0x5B05B05B, &AUX_a_Int64_h, &AUX_a_Int64_l);
	fcn = (Int32)(AUX_a_Int64_h >> 5);
	...
	F__I64MULI32U32(fcn, 0x49249249, &AUX_a_Int64_h, &AUX_a_Int64_l);
