...
*                                                                              
* FILE:                                                                        
*   FIR2_644.c         2000/03/22                                              
*                                                                              
*  Copyright (c) 2000 dSPACE GmbH, GERMANY                                     
*                                                                              
*  $Workfile: FIR2_644.c $ $Revision: 7 $ $Date: 14.01.04 16:27 $ $Author: Markuss $                           
******************************************************************************/
...
*
* Function:
*  F__I32FIR32_I8CBI8(Input,NTabs,DelayLine,Coeff,Counter)
*
* DESCRIPTION:
...
Int8    *AuxDelayLine;
	...
	*AuxDelayLine = Input; 
	...
	for(i=0;i<NTabs;i++)
	{
	   Accu += (Int32)((Int16)*AuxDelayLine++ * (Int16)*Coeff++);	    		
